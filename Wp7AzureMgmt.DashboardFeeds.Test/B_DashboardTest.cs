// -----------------------------------------------------------------------
// <copyright file="B_DashboardTest.cs" company="Microsoft">
...
namespace Wp7AzureMgmt.DashboardFeeds.Test
{
    ...
    public class B_DashboardTest 
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="B_DashboardTest" /> class.
        /// </summary>
        public B_DashboardTest()
        {
